...
like L<Net::XMPP2::Client> (see also L<SYNOPSIS> above).
...
This method sends a ping request to C<$dest> via the L<Net::XMPP2::Connection>
...
a L<Net::XMPP2::Error::IQ> error object.
