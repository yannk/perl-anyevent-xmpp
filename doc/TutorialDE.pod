=head1 Einführung in I<Instant Messaging> mit Net::XMPP2 (Jabber)

Eine Einführung in das Perl Modul L<Net::XMPP2> und wie man damit
...
Dieser Artikel soll eine kurze Einführung in L<Net::XMPP2>
geben. Angefangen bei einer kurzen Einführung in XMPP selbst,
geht es weiter mit einem Überblick über das Perl Modul L<Net::XMPP2>.
...
=head2 Net::XMPP2 Überblick

=over 4

=item * L<Net::XMPP2> ist ein Perl Modul zum Entwickeln von XMPP Clienten und Komponenten.
...
=item * Dazu implementiert L<Net::XMPP2> ein paar wichtige XEPs ohne die man keinen
ernsthaften IM Clienten der auf XMPP basiert entwickeln könnte.

=back

=head2 Die 2 in Net::XMPP2
...
=item * L<Net::XMPP2> hab ich geschrieben um:
...
=head2 Abhängigkeiten von Net::XMPP2
...
=head2 Net::XMPP2 Module

L<Net::XMPP2> enthält noch eine Reihe anderer (Unter-)Module.
Davon implementieren viele eher optionale Funktionalität.

Die wichtigsten und grundlegendsten Module in L<Net::XMPP2> sind hier
aufgelistet:
...
Ist von L<Net::XMPP2::Connection> abgeleitet und erweitert diese um I<Instant Messaging>
...
werde. Bei Interesse diese bitte in der Dokumentation von L<Net::XMPP2::Event> nachlesen.
