...
For example see the test suite of L<Net::XMPP2>.
...
C<$con> must be an object of the class L<Net::XMPP2::Connection> (or derived).
...
L<Net::XMPP2::Error::IQ> object.

C<$con> should be a L<Net::XMPP2::Connection> or an object from some derived class.
